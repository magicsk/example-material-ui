...
const VakPracovnikCreateContainer: React.FC<VakPracovnikFormContainerProps> = ({
  View,
}) => {
  const { id } = useParams()
  ...
  const filterProps = useFilter(searchParams, 'vak_pracovnik')
...
export default VakPracovnikCreateContainer
