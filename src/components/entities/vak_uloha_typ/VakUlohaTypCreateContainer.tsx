...
const VakUlohaTypCreateContainer: React.FC<VakUlohaTypFormContainerProps> = ({
  View,
}) => {
  const { id } = useParams()
  ...
  const filterProps = useFilter(searchParams, 'vak_uloha_typ')
...
export default VakUlohaTypCreateContainer
