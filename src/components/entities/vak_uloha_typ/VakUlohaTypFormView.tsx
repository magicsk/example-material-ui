...
import VakUlohaTypForm from '../../entities/vak_uloha_typ/VakUlohaTypForm'
import {
  Box,
  Button,
  CardActions,
...
const VakUlohaTypFormView: React.FC<Props> = ({
  data,
  onSubmit,
  onCopy,
  onDelete,
                ...
                <form onSubmit={formikProps.handleSubmit}>
                  <Grid container spacing={3}>
                    <FormCard title={'vak_uloha_typ'}>
                      <VakUlohaTypForm
                        rootName={'vak_uloha_typ_by_pk' ?? 'ROOT_NAME'}
                      />
                    </FormCard>
                  </Grid>
                  <CardActions>
                    ...
                    <LoadingButton
                      disabled={
                        !onDelete || data?.vak_uloha_typ_by_pk?.platny == null
                      }
                      loading={formikProps.isSubmitting}
                      loadingPosition="start"
                      color="error"
                      startIcon={
                        data?.vak_uloha_typ_by_pk?.platny ? (
                          <Delete />
                        ) : (
                          <Undo />
                        )
...
export default VakUlohaTypFormView
